...
#summ=result.extend(vlans)  так не работает , если метод ничего не возвращает то его (результат работы)  нельзя присвоить переменной
"""
Обработка такого метода и присвоение нужно делать отдельно
result.extend(vlans)
summ=result
print(summ)
"""
